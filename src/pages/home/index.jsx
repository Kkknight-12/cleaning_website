      ...
      <Box className="bg-blue-500 rounded-xl p-7 text-center">
        <Stack spacing={5}>
          <ImageCard
            ...
            heading={homePageContent.section_four.heading}
            paragraph={homePageContent.section_four.paragraph}
            image_path={homePageContent.section_four.image_path}
            image_alt={homePageContent.section_four.image_alt}
          />

          <ButtonComponent
            button_text={homePageContent.section_four.button_text}
            variant="outlined"
